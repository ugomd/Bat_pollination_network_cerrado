...
fMA <- as.matrix(read.delim("fMA.txt")) # Multiplications from here onwards...
fMF <- as.matrix(read.delim("fMF.txt")) 
...
fMAF <- as.matrix(read.delim("fMAF.txt")) 
fMAS <- as.matrix(read.delim("fMAS.txt")) 
fMFS <- as.matrix(read.delim("fMSF.txt")) 
fAFS <- as.matrix(read.delim("fAFS.txt")) 
fMASF <- as.matrix(read.delim("fMASF.txt")) 
...
ggplot(aic, aes(x=Order, y=delta)) +
...
nMA <- as.matrix(read.delim("nMA.txt")) 
...
nMAF <- as.matrix(read.delim("nMAF.txt")) 
nMAS <- as.matrix(read.delim("nMAS.txt")) 
nMFS <- as.matrix(read.delim("nMFS.txt")) 
nAFS <- as.matrix(read.delim("nAFS.txt")) 
nMASF <- as.matrix(read.delim("nMASF.txt")) 
...
tiff("likelihood.tiff", width = 10, height = 15, units = "cm", res = 600)  
ggplot(aic, aes(x=Order, y=delta)) +
  geom_col(col="lightgoldenrod2",fill="lightgoldenrod2",width=0.5) + coord_flip() +theme_classic()+
  theme(axis.title.x = element_text(color="black", face ="bold", size =17),
        axis.title.y = element_text(color="black", face ="bold", size =17), 
...
oMA <- as.matrix(read.delim("oMA.txt")) 
...
oMAF <- as.matrix(read.delim("oMAF.txt")) 
oMAS <- as.matrix(read.delim("oMAS.txt")) 
oMFS <- as.matrix(read.delim("oMSF.txt")) 
oAFS <- as.matrix(read.delim("oAFS.txt")) 
oMASF <- as.matrix(read.delim("oMASF.txt")) 
